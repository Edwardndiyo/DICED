...
const GamePage = () => {
  ...
  useEffect(() => {
    const fetchHighestScore = async () => {
      if (username) {
        try {
          const response = await axios.get(` http://edwardndiyoo.pythonanywhere.com/get_highest_score/${username}`);
  ...
  const handleEndGame = async () => {
    try {
      ...
      if (scores.total > existingHighestScore) {
        await axios.post(' http://edwardndiyoo.pythonanywhere.com/update_scores', {
          username,
      ...
      await axios.post(' http://edwardndiyoo.pythonanywhere.com/update_player_history', {
        username,
        beginner: scores.beginner,
        amateur: scores.amateur,
        pro: scores.pro,
